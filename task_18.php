                                ...
                                <div class="panel-content">
                                    <div class="form-group">
                                        ...
                                        <form action="handler.php" method="post" enctype="multipart/form-data">
                                            <input type="hidden" name="form" value="task18">

                                            <div class="form-group">
                                                <label class="form-label" for="simpleinput">Image</label>
                                                <input type="file" name="img" id="simpleinput" class="form-control">
                                            </div>
                                    ...
                                    <div class="row">
                                        ...
                                        foreach ($images as $image):
                                            ...
                                            <div class="col-md-3 image">
                                                ...
                                                <a class="btn btn-danger" href="/handler.php/?delete=<?=$image['id']?>" onclick="confirm('Вы уверены?');">Удалить</a>
                                            </div>
                                        <? endforeach;?>
